...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.02 seconds. Actual duty: 0%. */ .period_counts = (uint32_t) 0x1e8480, .duty_cycle_counts = 0x0, .source_div = (timer_source_div_t)0,
    .channel             = 1,
    .p_callback          = NULL,
    /** If NULL then do not add & */
#if defined(NULL)
...
{
    .p_ctrl        = &g_timer_1ms_ctrl,
    .p_cfg         = &g_timer_1ms_cfg,
    .p_api         = &g_timer_on_gpt
};
sci_uart_instance_ctrl_t     g_uart3_ctrl;
            ...
            {
                /* Baud rate calculated with 0.469% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 107, .mddr = (uint8_t) 256, .semr_baudrate_bits_b.brme = false
            };
...
const iic_master_extended_cfg_t g_i2c1_extend =
{
